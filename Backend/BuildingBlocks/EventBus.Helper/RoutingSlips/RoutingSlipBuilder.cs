...
{
	private readonly Dictionary<string, string> _blackboard;
	private readonly List<RoutingSlipCheckpointLog> _checkpointLogs;

	private readonly List<RoutingSlipCheckpoint> _checkpoints;
	...
	{
		foreach (var keyValuePair in keyValuePairs) _blackboard[keyValuePair.Key] = keyValuePair.Value;
	}
