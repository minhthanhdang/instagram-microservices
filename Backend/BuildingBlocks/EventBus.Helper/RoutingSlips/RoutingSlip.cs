...
{
	public RoutingSlip(Guid id, List<RoutingSlipCheckpoint> checkpoints, List<RoutingSlipCheckpointLog> checkpointLogs,
		RoutingSlipCheckpoint? rollbackDestination, Dictionary<string, string> blackboard)
	{
		Id = id;
