...
public class RabbitMQEventBusConfigurator : IRabbitMQEventBusConfigurator
{
	...
	public RabbitMQPublishingConfiguration Publishing { get; }
	public RabbitMQSubscribingConfiguration Subscribing { get; }
	public RabbitMQQosConfiguration Qos { get; }
	public List<IRabbitMQRequeuePolicy> RequeuePolicies { get; }
	...
	{
		if (!RequeuePolicies.Contains(requeuePolicy)) RequeuePolicies.Add(requeuePolicy);
		return this;
	}
	...
	public IRabbitMQEventBusConfigurator AddHealthCheck(string? name = null, HealthStatus? failureStatus = null,
