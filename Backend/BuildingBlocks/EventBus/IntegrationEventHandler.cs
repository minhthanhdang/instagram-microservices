...
{
	protected static readonly ActivitySource ActivitySource = new("IntegrationEvent");

	internal IntegrationEventHandlerBase() { }

	public abstract Task Handle(IntegrationEventBase integrationEvent, IIncomingIntegrationEventProperties properties,
		IIncomingIntegrationEventContext context);

	public abstract Task HandleFailure(IntegrationEventBase integrationEvent,
		IIncomingIntegrationEventProperties properties, IIncomingIntegrationEventContext context, Exception ex);
}
	...
	where TQueue : IntegrationEventQueue
{
	...
	public sealed override Task Handle(IntegrationEventBase integrationEvent,
	...
	public sealed override Task HandleFailure(IntegrationEventBase integrationEvent,
		IIncomingIntegrationEventProperties properties, IIncomingIntegrationEventContext context, Exception ex)
	{
		using var activity = ActivitySource.StartActivity(
	...
	public abstract Task Handle(TIntegrationEvent integrationEvent, IIncomingIntegrationEventProperties properties,
		IIncomingIntegrationEventContext context);

	public virtual Task HandleFailure(TIntegrationEvent integrationEvent, IIncomingIntegrationEventProperties properties,
		IIncomingIntegrationEventContext context, Exception ex)
	{
...
public abstract class
	IntegrationEventHandler<TIntegrationEvent> : IntegrationEventHandler<TIntegrationEvent, IntegrationEventQueue>
	where TIntegrationEvent : IntegrationEventBase { }