	...
	public static MongoDbBuilder AddMongoDb(this IServiceCollection services, Action<IMongoDbConfigurator> configure)
	{
		...
		if (configurator.HealthCheckConfiguration != null)
			services.AddHealthChecks().AddMongoDb(
				...
				name: configurator.HealthCheckConfiguration.Name,
				failureStatus: configurator.HealthCheckConfiguration.FailureStatus,
				tags: configurator.HealthCheckConfiguration.Tags,
				timeout: configurator.HealthCheckConfiguration.Timeout);
