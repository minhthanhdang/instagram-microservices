...
public class MongoDbBuilder
{
	...
	public MongoDbBuilder AddCollection<TDocument>(string databaseName, string collectionName,
		MongoCollectionSettings? settings = null)
	{
		...
		Services.AddScoped<IMongoCollectionContextBase>(services =>
			services.GetRequiredService<IMongoCollectionContext<TDocument>>());

		return this;
	}

	public MongoDbBuilder AddTransactionalEventsCollection(string databaseName,
		string collectionName = "__transactional_events_group")
	{
	...
	public MongoDbBuilder AddIdempotentOperationsCollection(string databaseName,
		string collectionName = "__idempotent_operation")
	{
