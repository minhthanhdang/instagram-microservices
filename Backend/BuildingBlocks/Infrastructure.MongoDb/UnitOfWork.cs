...
public class UnitOfWork : IUnitOfWork
{
	...
	{
		if (_domainEventsDispatcher != null) await _domainEventsDispatcher.DispatchDomainEventsAsync();
	...
	public async Task ExecuteOptimisticTransactionAsync(Func<Task> task, Action<ITransactionOptions>? options = null,
	...
	public async Task ExecuteTransactionAsync(Func<Task> task, Action<ITransactionOptions>? configureOptions = null,
		CancellationToken cancellationToken = default)
	{
