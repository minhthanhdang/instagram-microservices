...
public interface ITransactionalEventsCommandResolver
{
	...
	Task<long> UpsertEventsGroupAndGetLastSequenceNumber(DbContext context, string groupId, int eventsCount,
		DateTimeOffset currentTime, TimeSpan availableDelay);
}