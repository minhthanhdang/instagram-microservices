...
public static class ResilientTransactionExtensions
{
	...
	public static async Task ExecuteResilientTransaction(this DbContext dbContext, Func<Task> task,
		IsolationLevel? isolationLevel = null, bool resetContext = true, CancellationToken cancellationToken = default)
	{
